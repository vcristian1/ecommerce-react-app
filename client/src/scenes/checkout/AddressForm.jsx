...
export const AddressForm = ({
  ...
  return (
    <Box
     display="grid"
     gap="15px"
     // Repeat 4 times splitting it into 4 fractions with a minimum of 0 and a maximum of 1fraction 
     gridTemplateColumns="repeat(4, minmax(0, 1fr))"
     // Targetting anything that is an immediate child in the Box, and if its on mobile screen it will get a span of 4.
     sx={{
